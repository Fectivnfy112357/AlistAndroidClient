...
This project is indexed by GitNexus as **alist** (4613 symbols, 9874 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
